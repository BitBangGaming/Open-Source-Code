...
#define BUTTON_TILT_X_PIN		(14U)
#define BUTTON_TILT_X_PIN_HAL	(GPIO_PIN_14)
#define BUTTON_TILT_X_PORT 		(GPIOC)
#define BUTTON_TILT_X_BIT 		(1 << BUTTON_TILT_X_PIN)
#define BUTTON_TILT_X_SET 		(GPIO_BSRR_BS14)
#define BUTTON_TILT_X_CLEAR 	(GPIO_BSRR_BR14)

#define BUTTON_TILT_Y_PIN		(13U)
#define BUTTON_TILT_Y_PIN_HAL	(GPIO_PIN_13)
#define BUTTON_TILT_Y_PORT 		(GPIOC)
